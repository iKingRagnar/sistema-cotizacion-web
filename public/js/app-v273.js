...
<style>
  * { box-sizing: border-box; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
  ...
  .tpl-page { position: relative; width: 100%; max-width: 1024px; margin: 20px auto; box-shadow: 0 8px 32px rgba(0,0,0,0.3); background: #fff; aspect-ratio: 1024 / 1536; }
  ...
  .tpl-h1 { left:5.0%; top:30.6%; width:${leftWidthCss}; height:3.9%; }
  .tpl-f1 { left:5.0%; top:34.7%; width:${leftWidthCss}; height:21.7%; }
  .tpl-s1 { left:5.0%; top:56.6%; width:${leftWidthCss}; height:13.5%; }
  .tpl-i1 { left:5.0%; top:70.3%; width:${leftWidthCss}; height:6.5%; }
  .tpl-a1 { left:5.0%; top:76.9%; width:${leftWidthCss}; height:6.4%; }
  /* Lado derecho (modo PAIR): */
  .tpl-h2 { left:51.0%; top:30.6%; width:44%; height:3.9%; }
  .tpl-f2 { left:51.0%; top:34.7%; width:44%; height:21.7%; }
  .tpl-s2 { left:51.0%; top:56.6%; width:44%; height:13.5%; }
  .tpl-i2 { left:51.0%; top:70.3%; width:44%; height:6.5%; }
  .tpl-a2 { left:51.0%; top:76.9%; width:44%; height:6.4%; }
  /* Modo SINGLE: parche blanco gigante tapando el lado derecho del template original */
  .tpl-single-cover { left:50%; top:30.5%; width:46%; height:53%; background:#fff !important; border:none; }
  @media print {
...
<body>
  <div class="tpl-toolbar">
    <div style="background:#ff0066;color:#fff;padding:4px 12px;font-weight:900;font-size:13px;letter-spacing:1px;border-radius:4px;align-self:center;margin-right:auto">FLYER TEMPLATE v273 ACTIVO · modo: ${isSingle ? 'SINGLE' : 'PAIR'} · debug: ${debugMode ? 'ON' : 'OFF'}</div>
