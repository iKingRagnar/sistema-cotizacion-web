...
<style>
  * { box-sizing: border-box; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
  ...
  .tpl-h1 { left:5.0%; top:31.8%; width:${leftWidthCss}; height:3.5%; }
  .tpl-f1 { left:5.0%; top:35.5%; width:${leftWidthCss}; height:21.0%; }
  ...
  .tpl-h2 { left:51.0%; top:31.8%; width:44%; height:3.5%; }
  .tpl-f2 { left:51.0%; top:35.5%; width:44%; height:21.0%; }
  ...
  .tpl-single-cover { left:50%; top:31.5%; width:46%; height:52%; background:#fff !important; border:none; }
  @media print {
...
<body>
  <div class="tpl-toolbar">
    <div style="background:#ff0066;color:#fff;padding:4px 12px;font-weight:900;font-size:13px;letter-spacing:1px;border-radius:4px;align-self:center;margin-right:auto">FLYER TEMPLATE v274 ACTIVO · modo: ${isSingle ? 'SINGLE' : 'PAIR'} · debug: ${debugMode ? 'ON' : 'OFF'}</div>
