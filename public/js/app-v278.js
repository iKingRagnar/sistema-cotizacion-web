...
<body>
  <div class="tpl-toolbar">
    <div style="background:#ff0066;color:#fff;padding:4px 12px;font-weight:900;font-size:13px;letter-spacing:1px;border-radius:4px;align-self:center;margin-right:auto">FLYER VECTORIAL v278 ACTIVO · modo: ${isSingle ? 'SINGLE' : 'PAIR'} · debug: ${debugMode ? 'ON' : 'OFF'}</div>
...
<style>
  * { box-sizing: border-box; }
  ...
  /* Foto industrial (extraída del ejemplo1.jpeg): se muestra solo la parte superior derecha de la imagen,
     que contiene la máquina CNC con líquido refrigerante. Overflow:hidden del hero la recorta. */
  .uv-hero-fondo { position: absolute !important; top: -10px !important; right: 0 !important; width: 60% !important; height: auto !important; z-index: 1 !important; pointer-events: none; user-select: none; max-width: 60%; }
...
<body>
  ...
  <div class="uv-page">
    ...
    <!-- HEADER tipo ejemplo1: logo metálico arriba + título mega + cinta tagline + foto industrial fondo -->
    <div class="uv-hero">
      <img src="/img/flyer-template-ejemplo1.jpeg" class="uv-hero-fondo" alt="">
