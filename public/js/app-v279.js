...
<body>
  <div class="tpl-toolbar">
    <div style="background:#ff0066;color:#fff;padding:4px 12px;font-weight:900;font-size:13px;letter-spacing:1px;border-radius:4px;align-self:center;margin-right:auto">FLYER VECTORIAL v279 ACTIVO · modo: ${isSingle ? 'SINGLE' : 'PAIR'} · debug: ${debugMode ? 'ON' : 'OFF'}</div>
...
<style>
  * { box-sizing: border-box; }
  ...
  .uv-hero-fondo { display: block; width: 230%; height: auto; margin-left: -130%; margin-top: 0; user-select: none; pointer-events: none; }
...
<body>
  ...
  <div class="uv-page">
    ...
    <div class="uv-hero">
      ...
      <div class="uv-hero-right"><img src="/img/flyer-template-ejemplo1.jpeg" class="uv-hero-fondo" alt=""></div>
    </div>
