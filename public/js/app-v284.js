...
<body>
  <div class="tpl-toolbar">
    <div style="background:#ff0066;color:#fff;padding:4px 12px;font-weight:900;font-size:13px;letter-spacing:1px;border-radius:4px;align-self:center;margin-right:auto">FLYER VECTORIAL v284 ACTIVO · modo: ${isSingle ? 'SINGLE' : 'PAIR'} · debug: ${debugMode ? 'ON' : 'OFF'}</div>
...
<style>
  * { box-sizing: border-box; }
  ...
  /* ACCESORIOS: mismo tamaño que EQUIPO INCLUIDO (12px en lugar de 11px) */
  .uv-acc-list { margin: 0; padding: 0; list-style: none; display: grid; grid-template-columns: 1fr 1fr; gap: 4px 24px; }
  .uv-acc-list li { font-size: 12px; padding: 3px 0 3px 14px; position: relative; color: #fafafa; line-height: 1.35; }
  .uv-acc-list li::before { content: "•"; position: absolute; left: 2px; top: 1px; color: #FFD200; font-size: 16px; }
      ...
      <div class="cotz-modal">
        ...
        <section class="cotz-card" aria-labelledby="maq-sec-spec">
          ...
          <div class="form-row" style="gap:1rem;align-items:flex-start;margin-top:0.5rem">
            ...
            <div class="form-group" id="m-foto2-wrap" style="margin-bottom:0;flex:1;min-width:0;${curModo === 'pair' ? '' : 'display:none'}">
