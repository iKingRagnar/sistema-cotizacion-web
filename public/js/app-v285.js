...
<body>
  ...
  function previewMaquinaUniversal(m, opts) {
    ...
    // En modo PAIR sin máquina compañera del catálogo: si Luis subió una 2da foto
    // (imagen_ensamble_url), creamos una "máquina virtual" para el lado derecho del flyer
    // que duplica los datos de la principal pero con la foto 2 como foto principal.
