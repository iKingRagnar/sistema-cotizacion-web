...
<body>
  ...
  function previewMaquinaUniversal(m, opts) {
    ...
    if (modo === 'pair' && !companion && m && (m.modelo_2 || m.incluye_2 || m.accesorios_estandar_2 || m.ficha_tecnica_specs_2 || m.imagen_ensamble_url)) {
      companion = {
        id: null,
        modelo: m.modelo_2 || '',
        nombre: m.modelo_2 || '',
    ...
    const body = `
      <div class="cotz-modal">
        ...
        <section class="cotz-card" id="maq-sec-pair2-wrap" aria-labelledby="maq-sec-pair2" style="${curModo === 'pair' ? '' : 'display:none'}">
          ...
          <div class="form-group"><label>Modelo 2 (versión)</label>
