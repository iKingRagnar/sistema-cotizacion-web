...
<style>
  * { box-sizing: border-box; }
  ...
  .uv-bloque-acc { background: #0a0a0a; color: #fff; padding: 10px 28px 14px; margin: 0 22px 18px; border-radius: 0 0 4px 4px; border-top: 1px solid #2a2a2a; }
  ...
  .uv-bi-titulo.uv-acc { font-size: 16px; margin-bottom: 10px; }
  ...
  /* ACCESORIOS: bullets circulares amarillos del mismo tamaño que EQUIPO INCLUIDO. */
  .uv-acc-list { margin: 0; padding: 0; list-style: none; display: grid; grid-template-columns: 1fr 1fr; gap: 4px 24px; }
  .uv-acc-list li { font-size: 12px; padding: 3px 0 3px 24px; position: relative; color: #fafafa; line-height: 1.35; }
  .uv-acc-list li::before { content: ""; position: absolute; left: 0; top: 6px; width: 14px; height: 14px; background: #FFD200; border-radius: 50%; }
