...
<style>
  * { box-sizing: border-box; }
  ...
  .uv-hero-right {
    ...
    z-index: 1;
    pointer-events: none;
    -webkit-mask-image: linear-gradient(to right, transparent 0%, rgba(0,0,0,0.4) 18%, #000 45%);
    mask-image: linear-gradient(to right, transparent 0%, rgba(0,0,0,0.4) 18%, #000 45%);
  }
...
<body>
  ...
  <div class="uv-page">
    ...
    <div class="uv-hero">
      ...
      <div class="uv-hero-right"><img src="/img/flyer-foto-industrial.jpeg" class="uv-hero-fondo" alt=""></div>
    </div>
