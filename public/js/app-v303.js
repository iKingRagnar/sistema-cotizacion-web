...
<style>
  * { box-sizing: border-box; }
  ...
  .uv-hero-right {
    ...
    z-index: 1;
    pointer-events: none;
    background-image: linear-gradient(to right, #fff 0%, rgba(255,255,255,0.92) 15%, rgba(255,255,255,0.55) 30%, rgba(255,255,255,0) 50%), url('/img/flyer-foto-industrial.jpeg');
...
async function generarFlyerPDF() {
  ...
  // Aplicar .pdf-mode (compacta el flyer para que su proporción coincida con letter)
  flyer.classList.add('pdf-mode');
  // Esperar un frame para que CSS se aplique antes de capturar
