...
<style>
  * { box-sizing: border-box; }
  ...
  .uv-hero-right {
    ...
    z-index: 1;
    pointer-events: none;
    background-image: linear-gradient(to right, rgba(255,255,255,1) 0%, rgba(255,255,255,0.98) 10%, rgba(255,255,255,0.88) 20%, rgba(255,255,255,0.7) 30%, rgba(255,255,255,0.4) 40%, rgba(255,255,255,0.15) 50%, rgba(255,255,255,0) 60%), url('/img/flyer-foto-industrial.jpeg');
