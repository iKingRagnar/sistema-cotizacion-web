...
<style>
  * { box-sizing: border-box; }
  ...
  .uv-hero-right {
    ...
    z-index: 1;
    pointer-events: none;
    /* Múltiples gradients para fundir TODOS los bordes (izq + arriba + abajo) y evitar líneas rectas visibles */
    background-image:
      linear-gradient(to bottom, rgba(255,255,255,1) 0%, rgba(255,255,255,0) 12%, rgba(255,255,255,0) 88%, rgba(255,255,255,1) 100%),
      linear-gradient(to right, rgba(255,255,255,1) 0%, rgba(255,255,255,0.96) 12%, rgba(255,255,255,0.78) 25%, rgba(255,255,255,0.45) 38%, rgba(255,255,255,0.15) 50%, rgba(255,255,255,0) 62%),
