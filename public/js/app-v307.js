...
<style>
  * { box-sizing: border-box; }
  ...
  .uv-hero-stripes { position: absolute; top: 0; left: 0; width: 90px; height: 100%; z-index: 0; pointer-events: none; }
...
async function imprimirFlyer() {
  ...
  try {
    const pdf = await generarFlyerPDF();
    // Abrir el PDF en una nueva ventana y disparar print del PDF (consistente con el PDF descargado)
