...
async function imprimirFlyer() {
  // Mismo PDF custom-size (que ya se ve bien al descargar) y abrir en viewer del navegador
  // con auto-print. El usuario en el diálogo de Chrome elige 'Escala: Ajustar a página' (default
  // en muchas impresoras) y el PDF se imprime completo sin recortes.
