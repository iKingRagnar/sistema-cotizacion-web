...
<div class="cotizacion-doc-preview universal-doc" style="background:#fff;color:#0f172a">
  ...
  <div class="cdp-atendido-box" style="margin-top:10px;border:1px solid #cbd5e1;border-radius:8px;overflow:hidden">
    <div style="background:linear-gradient(180deg,#0f172a 0%,#1e3a5f 100%);color:#FFD200;font-weight:800;font-size:10px;letter-spacing:.12em;padding:6px 10px">👤 ATENDIDO POR</div>
    <div style="padding:8px 10px;background:#fff;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:6px">
      <div style="font-weight:700;font-size:12px;color:#0f172a">${escapeHtml(vendedorTxt)}</div>
      ${descPct ? `<span style="font-size:10px;color:#475569"><i class="fas fa-tag"></i> Descuento ${escapeHtml(descPct)}</span>` : ''}
  ...
  <div class="cdp-bancarios-box" style="margin-top:10px;border:1px solid #cbd5e1;border-radius:8px;overflow:hidden">
    <div style="background:linear-gradient(180deg,#0f172a 0%,#1e3a5f 100%);color:#FFD200;font-weight:800;font-size:10px;letter-spacing:.12em;padding:6px 10px">🏦 INFORMACIÓN BANCARIA</div>
    <div style="padding:6px 10px;background:#fffbeb;border-bottom:1px solid #fde68a;font-size:11px;color:#0f172a"><strong>UNIVERSAL MAQUINARIA S.A. DE C.V.</strong> &nbsp;·&nbsp; RFC: <span style="font-family:monospace;color:#b91c1c;font-weight:700">UMA000000XX0</span></div>
    <table style="width:100%;border-collapse:collapse;font-size:10px">
      <thead>
        <tr><th style="background:#FFD200;color:#0a0a0a;padding:5px;border:1px solid #c8a000">BANCO</th><th style="background:#FFD200;color:#0a0a0a;padding:5px;border:1px solid #c8a000">MONEDA</th><th style="background:#FFD200;color:#0a0a0a;padding:5px;border:1px solid #c8a000">CUENTA</th><th style="background:#FFD200;color:#0a0a0a;padding:5px;border:1px solid #c8a000">CLABE</th><th style="background:#FFD200;color:#0a0a0a;padding:5px;border:1px solid #c8a000">SUC.</th><th style="background:#FFD200;color:#0a0a0a;padding:5px;border:1px solid #c8a000">SWIFT</th></tr>
      </thead>
      <tbody>
        <tr><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">BANORTE</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">PESOS</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">0000000000</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">072000000000000000</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center">———</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center">———</td></tr>
        <tr style="background:#f8fafc"><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">BANORTE</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">DÓLARES</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">0000000000</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">072000000000000000</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center">———</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center">MENOMXMTXXX</td></tr>
        <tr><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">BANAMEX</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">PESOS</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">0000000</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">002000000000000000</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center">0000</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center">———</td></tr>
        <tr style="background:#f8fafc"><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">BANAMEX</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">DÓLARES</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">0000000</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center;font-family:monospace">002000000000000000</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center">0000</td><td style="padding:4px 6px;border:1px solid #e2e8f0;text-align:center">BNMXMXMMXXX</td></tr>
      </tbody>
    </table>
    <div style="padding:6px 10px;font-size:9.5px;color:#475569;background:#fff;line-height:1.3;border-top:1px solid #e2e8f0"><strong>Política de pago con cheque:</strong> Por seguridad financiera, la entrega de máquinas y/o refacciones se hará al siguiente día hábil del depósito previa confirmación de acreditamiento de fondos.</div>
  </div>
