        ...
        <section class="cotz-card">
          ...
          <div class="form-row" style="gap:1rem">
            <div class="form-group" style="flex:1;border:2px solid #FFD200;border-radius:8px;padding:0.75rem;background:rgba(255,210,0,0.05)">
              ...
              <div id="cot-prev-imagen" style="margin-top:0.5rem">${cot && cot.imagen_maquina_url ? '<img src="' + escapeHtml(cot.imagen_maquina_url) + '" style="max-width:200px;max-height:140px;border:1px solid #ccc;border-radius:6px">' : '<span class="muted" style="font-style:italic">— Aún no subes foto —</span>'}</div>
            </div>
            <div class="form-group" style="flex:1;border:2px solid #0a0a0a;border-radius:8px;padding:0.75rem;background:rgba(10,10,10,0.04)">
              ...
              <div id="cot-prev-ficha" style="margin-top:0.5rem;font-size:0.85rem">${cot && cot.ficha_tecnica_url ? '<a href="' + escapeHtml(cot.ficha_tecnica_url) + '" target="_blank"><i class="fas fa-paperclip"></i> Ver ficha técnica actual</a>' : '<span class="muted" style="font-style:italic">— Aún no subes ficha técnica —</span>'}</div>
            </div>
          </div>
    ...
    if (_imgFile) {
      _imgFile.addEventListener('change', async () => {
        ...
        try {
          ...
          if (prev) prev.innerHTML = '<img src="' + dataUrl + '" style="max-width:200px;max-height:140px;border:1px solid #ccc">';
        } catch (e) {
    ...
    if (_fichaFile) {
      _fichaFile.addEventListener('change', async () => {
        ...
        try {
          ...
          if (prev) prev.innerHTML = isPdf
            ? '<a href="' + dataUrl + '" target="_blank"><i class="fas fa-paperclip"></i> Ver ficha cargada (PDF)</a>'
            : '<img src="' + dataUrl + '" style="max-width:200px;max-height:140px;border:1px solid #ccc">';
        } catch (e) {
