  ...
  async function openModalCotizacion(cot) {
    ...
    function _renderFichaManual() {
      ...
      body.innerHTML = _fichaArr.map((r, i) => `
        <tr data-ficha-row="${i}">
          <td style="border:1px solid #ddd;padding:4px"><input type="text" data-fk="label" value="${escapeHtml(r.label||'')}" style="width:100%;border:none;background:transparent;padding:4px;font-weight:600" placeholder="Ej: Potencia"></td>
          <td style="border:1px solid #ddd;padding:4px"><input type="text" data-fk="value" value="${escapeHtml(r.value||'')}" style="width:100%;border:none;background:transparent;padding:4px" placeholder="Ej: 15 HP"></td>
          <td style="border:1px solid #ddd;padding:4px;text-align:center"><button type="button" class="btn small danger" data-ficha-del="${i}" title="Quitar"><i class="fas fa-trash"></i></button></td>
        </tr>`).join('');
