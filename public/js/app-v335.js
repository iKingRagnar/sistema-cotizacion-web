    ...
    <div class="uv-hero">
      ...
      <div class="uv-hero-left">
        <div class="uv-logo-bar">
          <svg viewBox="0 0 280 90" xmlns="http://www.w3.org/2000/svg" style="width:auto;height:auto;max-width:280px;max-height:90px;display:block" aria-label="UNIVERSAL MAQUINARIA">
            <defs>
              <linearGradient id="uvLogoGrad" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0" stop-color="#cfcfcf"/>
                <stop offset="0.5" stop-color="#f2f2f2"/>
                <stop offset="1" stop-color="#9a9a9a"/>
              </linearGradient>
            </defs>
            <rect x="2" y="6" width="276" height="78" rx="40" ry="40" fill="#0a0a0a" stroke="#000" stroke-width="2"/>
            <rect x="14" y="16" width="252" height="58" rx="30" ry="30" fill="url(#uvLogoGrad)" stroke="#0a0a0a" stroke-width="3"/>
            <text x="140" y="58" text-anchor="middle" font-family="Impact, 'Arial Black', sans-serif" font-size="42" font-weight="900" fill="#0a0a0a" letter-spacing="2">UNIVERSAL</text>
          </svg>
        </div>
