      ...
      <div class="uv-hero-left">
        <div class="uv-logo-bar">
          <div style="position:relative;display:inline-block;line-height:0">
            <img src="/fondos/universal-logo.jpg?v=4" alt="UNIVERSAL MAQUINARIA" class="uv-logo-img" style="max-width:280px;width:auto;height:auto;max-height:120px;display:block;object-fit:contain;background:transparent;mix-blend-mode:multiply" onerror="this.parentNode.outerHTML='<div class=&quot;uv-logo-fallback&quot;><div class=&quot;uv-logo-main&quot;>UNIVERSAL</div><div class=&quot;uv-logo-sub&quot;>MAQUINARIA</div></div>'">
            <!-- Tapa pestañita superior derecha con la misma foto industrial de fondo (se funde visualmente) -->
            <span aria-hidden="true" style="position:absolute;top:0;right:0;width:12%;height:38%;background:url('/img/flyer-foto-industrial.jpeg') center right / 600% 600%;pointer-events:none"></span>
            <!-- Tapa pestañita inferior derecha -->
            <span aria-hidden="true" style="position:absolute;bottom:0;right:0;width:12%;height:38%;background:url('/img/flyer-foto-industrial.jpeg') center right / 600% 600%;pointer-events:none"></span>
          </div>
        </div>
