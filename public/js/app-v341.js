...
<div class="cotizacion-doc-preview universal-doc" style="background:#fff;color:#0f172a">
  ...
  function mapReporteModalTipo(rep) {
    ...
    if (t === 'david_cantu') return { tipo: 'venta', subtipo: rep.subtipo || 'david_cantu' };
  ...
  function refreshReporteSubtipoFilterOptions() {
    ...
    if (tipo === 'garantia' || tipo === 'instalacion' || tipo === 'capacitacion' || tipo === 'cotizacion' || tipo === 'david_cantu') tipo = 'venta';
    const map = {
      servicio: [
        { v: '', t: 'Todos (servicio)' },
  ...
  function openModalReporte(reporte) {
      ...
      <div class="form-row">
        <div class="form-group"><label>Actividad *</label>
          <select id="m-tipo-rep">
            ...
            <option value="david_cantu" ${modalTipoInicial.tipo === 'david_cantu' || (modalTipoInicial.tipo === 'venta' && modalTipoInicial.subtipo === 'david_cantu') ? 'selected' : ''}>David Cantú</option>
          </select>
        </div>
    ...
    qs('#m-save').onclick = async () => {
      ...
      if (['instalacion','garantia','capacitacion','cotizacion','david_cantu'].includes(tipoSelVal)) {
        tipo = 'venta';
