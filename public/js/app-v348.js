  ...
  function openModalAgendaDia(dateIso, items, asigns) {
    ...
    const renderAsignFull = (a) => {
      ...
      return `<div class="ag-asign-card">
        ...
        <div class="ag-box-libre">
          <div class="ag-libre-head"><i class="fas fa-check-circle"></i> ${escapeHtml(a.tecnico||'Este técnico')} está LIBRE en:</div>
          <div style="line-height:2.2;margin-top:4px">${libresHtml}</div>
        </div>
