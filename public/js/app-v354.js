  ...
  function openModalAgendaDia(dateIso, items, asigns) {
    ...
    const renderAsignFull = (a) => {
      ...
      return `<div class="ag-asign-card">
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:10px;flex-wrap:wrap">
          ...
          <strong style="font-size:1.05rem">${escapeHtml(a.tecnico||'—')}</strong>
    ...
    SLOTS_ORDER.forEach(s => {
      ...
      if (!arr.length) {
        ...
        const tecnicosHtml = arr.map(a => `<div class="agenda-slot-tecnico">
          <span style="width:14px;height:14px;border-radius:50%;background:linear-gradient(135deg,#dc2626,#991b1b);color:#fff;display:inline-flex;align-items:center;justify-content:center;font-size:0.55rem;box-shadow:0 1px 2px rgba(0,0,0,0.3)"><i class="fas fa-lock"></i></span>
        ...
        html += `<div class="agenda-slot-block ocupado">
          <div class="agenda-slot-head">
            <span>${meta.icon} ${meta.titulo}</span>
            <span class="agenda-slot-estado ocupado">Ocupado</span>
          </div>
          <div class="agenda-slot-hora"><i class="far fa-clock"></i> ${meta.hora}</div>
          ${tecnicosHtml}
          ${detalleHtml}
