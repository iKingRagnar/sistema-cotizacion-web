...
(function premiumUX() {
  ...
  function boot() {
    ...
    /* initSkeletonLoaders — off (shimmer / animación) */
    initSavedFilters();
    initBulkActions();
    initToastHelper();
    /* initDashboardSparklines — off (canvas animado) */
    initColumnReorder();
    initAttachments();
    initDashboardReorder();
    /* initRippleEffect — off (hover / click motion) */
    initSidebarTooltips();
    initPremiumTooltips();
    initAriaLabels();
    initRowClickHighlight();
    /* initConfettiHelper — off */
    /* initDashboardPulse — off */
    initUserAvatar();
    initPrintButtons();
    /* initSwipeActions — off (filas que se mueven) */
    initAutoAttachments();
    /* initPullToRefresh — off (indicador en movimiento) */
    initPWAInstall();
    initAuditViewer();
    initWebhooksUI();
